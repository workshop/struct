...
RSpec.describe StructCore::Specwriter12X do
	describe '#write' do
		it 'can write a fully featured spec file' do
			...
			spec = parser.parse StructCore::SPEC_VERSION_120, test_hash, project_file
			...
			spec_2 = nil
			expect { spec_2 = parser.parse StructCore::SPEC_VERSION_120, spec_2_hash, project_file }.to_not raise_error
