...
RSpec.describe StructCore::Specparser11X do
	describe '#can_parse_version' do
		SPEC_VERSION_11X = Semantic::Version.new('1.1.0').freeze

		it 'specifies that it can only parse Spec versions 1.1.X' do
			parser = StructCore::Specparser11X.new

			expect(parser.can_parse_version(SPEC_VERSION_11X)).to be_truthy
		...
		describe '#parse' do
			it 'can parse a specfile with only configurations' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_2.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new

				proj = parser.parse SPEC_VERSION_11X, test_hash, project_file
			...
			it 'raises an error if a project doesn\'t contain configurations' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_3.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new

				expect { parser.parse SPEC_VERSION_11X, test_hash, project_file }.to raise_error(StandardError)
			end

			it 'can parse a specfile with only 1 configuration' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_4.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'raises an error if a project has an invalid targets section' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_5.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'raises an error if a project has an invalid configurations section' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_6.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'raises an error if a project has an invalid profiles section in a configuration block' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_7.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'raises an error if a project has a missing profiles section in a configuration block' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_8.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'can parse a specfile with invalid overrides or types' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_9.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'can parse a specfile with overrides and types' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_10.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'skips targets within a specfile that contain no configuration' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_11.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'skips targets within a specfile that contain no type' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_12.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'can parse a specfile with a string sources entry' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_13.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'can parse a specfile with a i18n-resources entry' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_14.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'can parse a specfile with excludes entries' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_15.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'ignores excludes in a specfile with an invalid excludes block' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_16.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'ignores excludes in a specfile with an invalid excludes files block' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_17.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'parses a specfile with an sdkroot framework reference' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_18.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'parses a specfile with an sdkroot library reference' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_19.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'parses a specfile with a local project framework reference' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_20.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'ignores a references group in a specfile with an invalid references block' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_21.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'parses a specfile with a local framework reference' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_23.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'parses a specfile with a local framework reference containing options' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_24.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'parses a specfile with a script file' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_25.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
			...
			it 'ignores an invalid scripts section' do
				project_file = File.join(File.dirname(__FILE__), '../support/spec_parser_11X/spec_parser_11X_test_26.yml')
				test_hash = YAML.load_file project_file
				parser = StructCore::Specparser11X.new
