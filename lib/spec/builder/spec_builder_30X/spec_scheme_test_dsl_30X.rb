require_relative 'spec_scheme_test_environment_dsl_30X'

module StructCore
	class SpecSchemeTestDSL30X
		...
		def environment(&block)
			...
			dsl = StructCore::SpecSchemeTestEnvironmentDSL30X.new
		...
		def build_configuration(args = '')
			...
			@test_action.build_configuration = args
		end
